<?php
namespace Dibs\EasyCheckout\Block\Subscription\Info;
...
class Buttons extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'Dibs_EasyCheckout::order/info/buttons.phtml';
    ...
    public function getNetsSubscriptionId()
    {
        ...
        if ($this->getOrder()->getPayment()->getMethod() == "dibseasycheckout") {
            $netsSubscriptionId = $order->getNetsSubscriptionEnddate();
        }
        return $netsSubscriptionId;
    }
