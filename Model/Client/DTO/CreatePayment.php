...
class CreatePayment extends AbstractRequest {
    ...
    /** @var CreateUnscheduledSubscriptionOrder[] */
    protected $unscheduledSubscription;
    ...
    /**
     * @return CreateUnscheduledSubscriptionOrder[]
     */
    ...
    /**
     * @param CreateUnscheduledSubscriptionOrder[] $unscheduledSubscription
     * @return CreatePayment
     */
    public function setUnscheduledSubscription($unscheduledSubscription) {
	...
	if (isset($this->unscheduledSubscription)) {
	    $webhooks = [];
            foreach ($this->webHooks as $w) {
                $webhooks[] = $w->toArray();
            }
            $data['unscheduledSubscription'] = $this->unscheduledSubscription->toArray();
        }
