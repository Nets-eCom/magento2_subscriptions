...
class NewOrderSubscription implements ObserverInterface {
     ...
     * @param \Dibs\EasyCheckout\Helper\Config $dataHelper
     */
    public function __construct(
        ...
        \Dibs\EasyCheckout\Helper\Data $dataHelper,
    ...
    public function execute(\Magento\Framework\Event\Observer $observer) {
        $isNewOrderEnable = $this->dataHelper->getConfigVal('notification_subscription/generalgroup/enabled');
        ...
        if($isNewOrderEnable){
            ...
            $from = $this->dataHelper->getConfigVal('notification_subscription/generalgroup/send_from');
            $to = [
                'email' => $this->dataHelper->getConfigVal('notification_subscription/generalgroup/email'),
                'name' => 'Administrator'
            ];
            $templateId = $this->dataHelper->getConfigVal('notification_subscription/generalgroup/template');
            $subject = $this->dataHelper->getConfigVal('notification_subscription/generalgroup/subject');
